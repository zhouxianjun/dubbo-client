...
Constants.CLUSTER_AVAILABLE_CHECK_KEY = 'cluster.availablecheck'; //集群时是否排除非available的invoker
Constants.DEFAULT_CLUSTER_AVAILABLE_CHECK = true;
Constants.DEFAULT_KEY_PREFIX = 'default.';
Constants.CLUSTER_STICKY_KEY = 'sticky'; //集群时是否启用sticky策略
Constants.DEFAULT_CLUSTER_STICKY = false;
